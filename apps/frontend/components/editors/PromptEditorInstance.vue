...
<template>
  <div class="prompt-editor-instance h-full flex flex-column align-items-center justify-content-center">
    <div class="text-center">
      <i class="pi pi-comment text-6xl text-color-secondary mb-4"></i>
      <h3 class="text-color-secondary mb-2">Prompt Editor</h3>
      ...
      <div class="w-full max-w-md">
        <Textarea
          v-model="content"
          placeholder="Temporary prompt editor..."
          class="w-full"
          rows="6"
        />
      </div>
